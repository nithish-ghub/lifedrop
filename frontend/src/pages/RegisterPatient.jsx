...
const RegisterPatient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.latitude || !formData.longitude) {
      setError('Please capture your current location coordinates.');
      return;
    }
    ...
    if (result.success) {
      setSuccess('Patient registered successfully! Redirecting to dashboard...');
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="w-full max-w-2xl space-y-8 rounded-2xl border border-gray-100 bg-white p-8 shadow-md">
          <div className="text-center">
            ...
            <h2 className="mt-4 text-3xl font-extrabold text-gray-900">Patient Registration</h2>
            <p className="mt-2 text-sm text-gray-500">
              Register to create immediate emergency blood requests when in need.
            </p>
          </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            {/* Address & Location */}
            <div className="bg-gray-50 p-4 rounded-xl space-y-4">
              <h3 className="text-sm font-bold text-gray-800 uppercase tracking-wider">Current Address</h3>
